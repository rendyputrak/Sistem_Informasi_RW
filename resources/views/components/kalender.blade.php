    ...
    <div class="max-w-sm w-full shadow-lg rounded-2xl overflow-hidden dark:border-gray-700 border-[1.6px] border-gray-200">
        <div class="md:p-8 p-5 dark:bg-gray-800 bg-white rounded-t">
            <div class="px-4 flex items-center justify-between">
                <span tabindex="0"
                    class="focus:outline-none  text-base font-bold dark:text-gray-100 text-gray-800">October 2020</span>
                                ...
                                <div class="w-full h-full">
                                    <div class="flex items-center justify-center w-full rounded-full cursor-pointer">
                                        <a role="link" tabindex="0"
                                            class="focus:outline-none  focus:ring-2 focus:ring-offset-2 focus:ring-w-primer focus:bg-w-hover hover:bg-w-hover text-base w-8 h-8 flex items-center justify-center font-medium text-white bg-w-primer rounded-full">8</a>
                                    </div>
                                </div>
                            </td>
                            <td>
        ...
        <div class="md:py-8 py-5 md:px-12 px-5 dark:bg-gray-700 bg-gray-200 rounded-b">
            <div class="">
                <div class="border-b pb-4 border-gray-400 border-dashed">
                    ...
                    <p class="text-sm pt-2 leading-4 text-gray-600 dark:text-gray-300">Discussion on UX sprint and
                        Wireframe review</p>
                </div>
