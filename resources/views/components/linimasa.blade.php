<ol class="relative border-s-[1.6px] border-gray-200 dark:border-gray-700 ml-3">
    <li class="mb-10 ms-6">
        <span
            class="absolute flex items-center justify-center w-6 h-6 rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 bg-w-primer">
            <svg class="w-2.5 h-2.5 text-w-putih dark:text-w-putih" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
        ...
        <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">Flowbite Application UI
            v2.0.0 <span
                class="bg-w-primer text-w-putih text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-w-primer dark:text-w-putih ms-3">Latest</span>
        </h3>
    ...
    <li class="mb-10 ms-6">
        <span
            class="absolute flex items-center justify-center w-6 h-6 bg-w-primer rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 dark:bg-w-primer">
            <svg class="w-2.5 h-2.5 text-w-putih dark:text-w-putih" aria-hidden="true"
