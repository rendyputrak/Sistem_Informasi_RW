        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-20">
            <div class="bg-gray-900 md:col-span-4 text-white">
                ...
                <h3 class="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight">
                    Get In <span class="text-w-primer">Touch</span>
                </h3>
                ...
                <div class="flex items-center mt-5">
                    <svg class="h-6 mr-2 text-w-primer" fill="currentColor" version="1.1"
            ...
            <form action="https://fabform.io/f/{form-id}" method="post" class="md:col-span-8 pl-4">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="flex justify-between w-full px-3">
                        ...
                        <button
                            class="shadow bg-w-primer hover:bg-indigo-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-6 rounded"
                            type="submit">
                            Kirim Laporan
                        </button>

                    </div>
                    <a href="https://veilmail.io/e/FkKh7o" class="font-medium text-blue-600 hover:underline">Or click
                        here
                        to reveal our protected email address</a>
