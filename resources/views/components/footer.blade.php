    ...
    <div class="w-full max-w-screen-xl mx-auto">
        <div class="sm:flex sm:items-center sm:justify-between">
            <a href="#hero-section" class="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-lg font-bold whitespace-nowrap dark:text-white">RW 03 Bunulrejo</span>
            </a>
        ...
        <span class="block text-sm text-gray-700 sm:text-center dark:text-gray-400">© 2023  <a href="#hero-section"
