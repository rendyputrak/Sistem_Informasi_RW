...
<body>
    ...
    <section class="hero">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6 d-flex align-items-center containerImgHero">
    ...
    <section class="info" id="info" data-aos="fade-in">
        <div class="container-fluid">
            <div class="row">
                <div class="col-3 headerPengumuman d-flex justify-content-center">
                    <h3 class="subHeroHeader text-center">Pengumuman dan Berita <div class="d-inline">Terkini</div>
                    </h3>
                </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    <div class="card card_program shadow-lg" style="width: 100%;">
                    ...
                    <div class="card shadow-lg agendaSub">
                        <div class="card-body">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-2">
                                    <div class="labelMain text-center d-flex justify-content-center">
                                        <div class="wrapanjay">
                ...
                <div class="card shadow-lg agendaSub">
                    <div class="card-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-2">
                                <div class="labelMain text-center d-flex justify-content-center mt-3  mt-3">
                                    <div class="wrapanjay">
                                        <div class="labelWrapper d-flex justify-content-center align-items-center">
                                            Label
                                        </div>
                ...
                <div class="card shadow-lg agendaSub">
                    <div class="card-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-2">
                                <div class="labelMain text-center d-flex justify-content-center  mt-3">
                                    <div class="wrapanjay">
                                        <div class="labelWrapper d-flex justify-content-center align-items-center">
                                            Label
                                        </div>
